...
class TestHabit:
    ...
    def test_fetch_check_of_habit_that_has_not_been_performed_then_returned_year_2000_and_0_checks(self):
        habit_a = Habit(self.test_db)
        habit_a.new_habit()

        assert self.test_db.load_latest_check(habit_a.habit_id) == datetime(2000, 1, 1)
